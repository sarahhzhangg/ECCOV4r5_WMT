...
- **ECCO_WMT_paper_annual.ipynb**: Figs. 1b, 2a-b, 3a-d, S1, S2b-c, S3
...
- **freeboard_data_sfig2a**: Contains dataframes of the monthly mean freeboards from ICESat-2 and ECCO V4r5.