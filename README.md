...
ECCO Version 4, release 5 (V4r5) is available [here](https://github.com/MITgcm-contrib/llc_hires/tree/master/llc_90/ecco_v4r5). We run V4r5 to obtain monthly outputs from January 1992-November 2024 at 1$^\circ$ of the following fields:
  - oceFWflx
  - SIatmFW
  - oceQnet
  - THETA
