...
- **slopes_rs_wholeSIZ.npz**: Contains monthly $A'$, $F_b'$, and SIE and their correlations in the whole sea ice zone used in this study ($\sigma_2 = [1035.60, 1037.25]$). Created in ECCO_WMT_paper_correlationcalc.ipynb.
- **slopes_rs_melt.npz**: Contains monthly $A'$, $F_b'$, and SIE and their correlations in the sea ice melt region used in this study ($\sigma_2 = [1035.95, 1036.70]$). Created in ECCO_WMT_paper_correlationcalc.ipynb.
- **slopes_rs_formation.npz**: Contains monthly $A'$, $F_b'$, and SIE and their correlations in the sea ice formation region used in this study ($\sigma_2 = [1036.79, 1037.25]$). Created in ECCO_WMT_paper_correlationcalc.ipynb.
